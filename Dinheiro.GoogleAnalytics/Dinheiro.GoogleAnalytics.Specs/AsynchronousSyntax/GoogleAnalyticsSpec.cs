...
namespace Dinheiro.GoogleAnalytics.Specs.AsynchronousSyntax
{
    public abstract class InMemoryRenderContext : WithFakes
    {
        Establish context = () =>
        {
            GoogleAnalytics.TrackingType = GoogleAnalyticsTrackingType.ga_js;
    ...
    public class When_events_are_to_be_tracked : InMemoryRenderContext
    {
        ...
        {
            Output.ShouldContain("_gaq.push(['_trackEvent','Unsubscribe','Submit']);");
